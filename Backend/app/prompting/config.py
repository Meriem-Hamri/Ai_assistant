...
class PromptConfig:
    ...
    system_instruction: str = (
        ...
        "utilise exactement le fallback adapté à la langue de la question "
        ...
        "valeur ou de détail non demandé. Pour toute valeur qui ne nécessite "
        "pas de calcul, notamment un montant, recopie exactement tous les "
        "chiffres, le séparateur et l'unité présents dans le contexte. "
        ...
        "les passages. Utilise le fallback linguistique fourni uniquement "
        "lorsque le contexte ne permet réellement "
        "pas une réponse fondée. "
        "Réponds dans la langue de la question, de manière concise et naturelle."
    )
